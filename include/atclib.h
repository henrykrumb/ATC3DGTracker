...
// forward declarations for libusb data structures
struct usb_device;
...
public:
    ...
    /*!
	 * Evaluate whether the system is initialized properly.
	 */
    bool operator!() const;
    bool ok() const;

    int setSuddenOutputChangeLock(int iSensorId, bool on=true);
